...
async function getMerchantOrderUrl(details, accessToken, frontendBaseUrl) {
    try {
        ...
        const orderData = {
            ...
            description: details.description || `Cleaning service payment`,
            billing_address: {
                country_code: 'KE',
                phone_number: details.phoneNumber,
                email_address: details.email || 'customer@cleaningservice.com',
            ...
            callback_url: `${frontendBaseUrl}/client/payments`,
